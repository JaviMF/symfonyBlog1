...
class PostControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $this->assertTrue($client->getResponse()->isSuccessful(), 'The response was not successuful');
        ...
        $form = $crawler->selectButton('Update')->form(
            array(
                'blog_modelbundle_post[title]'  => 'Update post'
            )
        );
        ...
        // Check the element contains an attribute with value equals "Update post"
        $this->assertGreaterThan(0, $crawler->filter('[value="Update post"]')->count(), 'The edited post is not showing up');
        ...
        $this->assertNotRegExp('/Update post/', $client->getResponse()->getContent());
    }
}